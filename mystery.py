...
class Mystery(object):
  ...
  def __init__(self, host, port, width, height, layer=0, transparent=False):
    ...
    Args:
      host: The mystery server hostname or ip address.
      port: The mystery server port number.
      width: The width of the mystery display in pixels.
      height: The height of the mystery display in pixels.
      layer: The layer of the mystery display to write to.
